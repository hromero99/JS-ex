...
/*
    Con el conjunto de objetos definido data queremos mostrar por consola cada una de las propiedades de las personas
    y agregar al array adress las direcciones de cada uno de ellos
*/

const direcciones = []

const propiedades = ["id","firstname","lastname","email","phone","birthday","address","gender","website","image"]

for (let index = 0; index < data.length; index++ ){
    // Aqui dentro tenemos informacion de una persona 
    // iterando para cada una de las personas
    for (let index2 = 0; index2 < propiedades.length; index2++){
        // Aqui tenemos acceso a cada una de las propiedades para una persona en concreto
        // data[index][propiedades[index2]]
        if (propiedades[index2] !== "address"){
            console.log(data[index][propiedades[index2]])
        }
        else{
            direcciones.push(data[index][propiedades[index2]])
        }
    }
}
